        ...
        <div className="py-12 2xl:px-20 px-6 xl:mx-auto xl:container">
          <div className="flex flex-col items-center">
            ...
            <p className="text-base leading-normal text-gray-600 mt-5 text-center md:w-3/5">
              Hello, You are here because you want to communicate in some way
              with me.{" "}
              <span className="font-bold">I think that’s pretty cool.</span>
            </p>

            <div className="container mx-auto grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mt-10 gap-6">
              <div className="bg-white border rounded-md border-indigo-400 h-64 flex flex-col items-center">
                <div
              ...
              <div className="bg-white border rounded-md border-indigo-400 h-64 flex flex-col items-center ">
                ...
                <p className="text-base mt-4 leading-4 text-center text-gray-600">
                  david.j.forer@gmail.com
                </p>
                <p className="text-base mt-4 leading-4 text-center text-gray-600">
                  david@davidjforer.com
                </p>
              </div>
              <div className="bg-white border rounded-md border-indigo-400 h-64 flex flex-col items-center ">
                <div
                ...
                <p className="text-base mt-4 leading-6 text-center text-gray-600 w-54">
                  2-4-1 Azabujuban <br /> Minato-ku, Japan 001-0045
                </p>
              </div>
            </div>
          </div>
