  ...
  return (
    ...
    <div className="border-t-2 border-gray-300 dark:border-white-300 w-screen" />
      <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
        <h1 className="text-center text-3xl lg:text-5xl tracking-wider text-indigo-700 font-bold">
          How Do I Start?
        </h1>
          ...
          <div className="hidden md:flex justify-center w-full">
            <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
              ...
              <div className="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
                <h1 className="text-2xl tracking-wide font-semibold">
                  Review Our Plan (BUILD)
                </h1>
                <p className="text-gray-700 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide">
                  We will discuss what the timeframes are for the project. Set
                  out a roadmap with key dates for project completion. Discuss
                  everything that will need to be done and create a checklist.
                </p>
              </div>
              <svg
                className="mt-24"
            ...
            <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
              ...
              <div className="flex mt-12 flex-col items-center md:items-start md:w-8/12">
                <h1 className="text-2xl tracking-wide font-semibold">
                  Have an Introductory Meeting (DESIGN)
                </h1>
                <p className="text-gray-700 mt-3 text-base leading-6 tracking-wide">
                  {" "}
                  Discuss what your wants, needs, and desires are for a website.
                  Come to agreement on what should be accomplished and in what
                  time-frame.{" "}
                </p>
              </div>
              <svg
              ...
              <div className="flex mt-12 flex-col items-center md:items-start md:w-8/12">
                <h1 className="text-2xl tracking-wide font-semibold">
                  Finished product (DEPLOY)
                </h1>
                <h2 className="text-gray-700 mt-3 text-base leading-6 tracking-wide">
                  Our final meeting will be to go over the final product. I will walk you through all the changes and how to keep the website up to date.
                </h2>
              </div>
            </div>
          </div>
